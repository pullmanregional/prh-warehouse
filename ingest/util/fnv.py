# FNV hash implementation from: https://github.com/povilasb/pyfnv
# Also see description at : http://isthe.com/chongo/tech/comp/fnv/
#
# Use with:
#
#  data = 'my data'
...
def hash(
    data: bytes, algorithm: Callable[[int, int, int], int] = fnv_1a, bits: int = 128
) -> int:
    ...
    return functools.reduce(
        functools.partial(algorithm, bits=bits), data, OFFSET_BASIS[bits]
    )
